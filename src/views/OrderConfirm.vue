      ...
      <div class="item-list-wrap confirm-item-list-wrap">
        <div class="cart-item order-item">
          ...
          <ul class="cart-item-list">
            <li v-for="item in cartList" v-if="item.checked ==='true'">
      ...
      axios.get("users/cartList").then((response)=>{
        ...
        this.cartList.forEach((item)=>{
          if(item.checked === 'true'){
            ...
            this.tax = Math.trunc(this.subTotal*0.2);
            this.discount = Math.trunc(this.subTotal*0.1);
            if(this.subTotal>666){
              this.shipping = 0;
            }else{
              this.shipping = Math.trunc(this.subTotal*0.01);
            }
          }
        });
